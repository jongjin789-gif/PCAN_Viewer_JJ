...
exe = EXE(
    ...
    a.datas,
    [],
    name='PCAN_Viewer_JJ_R006_linux',
    debug=False,
    ...
    icon=['/mnt/d/Project/.Common/Test/PCAN_Viewer_JJ/PCAN_Viewer_JJ_R006/icon/viewer.ico'],
)
